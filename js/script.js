...
async function main() {
    ...
    await getsongs("song/cs");   //agar galti hai toh yaha songs kardena
    // console.log(songs);
    ...
    //add an event listener for humberger
    document.querySelector(".hamburger").addEventListener("click", () => {
        document.querySelector(".left").style.left = "0"
    })

    // hogya bas mera abb(this make sure that hamburger opens when card is touched in phone)
    document.querySelector(".cardContainer").addEventListener("click", () => {
        document.querySelector(".left").style.left = "0";
    });

    // add an event listenre for close button
